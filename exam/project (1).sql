...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 05, 2022 at 07:40 AM
...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `ranking` ()  SELECT * FROM rank$$
...
('55846be776610', 'testing', 'sanjanashivashankara@gmail.com', 'testing', 'testing stART', '2015-06-19', '09:22:15pm');
...
('abrojackhimanshu@gmail.com', '5589222f16b93', 1, 2, 1, 1, '2015-06-24 03:22:38'),
('vachurai13@gmail.com', '5589222f16b93', 4, 2, 2, 0, '2022-01-31 02:33:42');
...
('vachurai13@gmail.com', 4, '2022-01-31 02:33:42');
...
('Vachana J Rai', 'F', 'TT', 'vachurai13@gmail.com', 1234566895, '25f9e794323b453885f5181f1b624d0b'),
...
--
DELIMITER $$
CREATE TRIGGER `user_del` BEFORE DELETE ON `user` FOR EACH ROW INSERT INTO history SET name=OLD.Name
$$
DELIMITER ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `user_view`  AS SELECT `user`.`name` AS `Name`, `user`.`college` AS `College` FROM `user` ;
